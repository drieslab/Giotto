...
showPatternGenes(VC_test, pattern_VC, dimension = 1, save_plot = F)
...
spatGenePlot(VC_test, expression_values = 'scaled', show_plot = F,
             genes = head(ranktest$genes,8), point_size = 2, cow_n_col = 4,
...
![](./figures/9_heatmap_correlated_genes.png){width=16cm} 

spatial co-expression cluster ranking:    
![](./figures/9_rank_correlated_groups.png){width=16cm} 

spatial co-expression metagene plots:  
![](./figures/9_spat_enrichment_score_plots.png){width=16cm} 
