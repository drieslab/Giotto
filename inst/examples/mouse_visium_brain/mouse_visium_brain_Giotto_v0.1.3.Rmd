...
raw_matrix = convertEnsemblToGeneSymbol(matrix = raw_matrix, species = 'mouse') # slow, not finishing within 3 min
...
# error message
# Error in spatDimPlot(gobject = DG_subset, cell_color = "leiden_clus",  : 
#   unused argument (point_size = 5)
...
ranktest = binGetSpatialGenes(visium_brain, bin_method = 'rank',
                              do_fisher_test = T, community_expectation = 5,
                              spatial_network_name = 'spatial_network', verbose = T) # not finishing within 10 min
spatGenePlot(visium_brain, expression_values = 'scaled',
