...
## spatial results
spatial_results = fread(paste0(data_dir,'spatial/tissue_positions_list.csv'))
...
# error message
# Error in spatDimGenePlot(visium_kidney, expression_values = "scaled",  : 
#   unused argument (point_size = 1)
...
kidney_sc_markers = as.data.table(readxl::read_excel(sheet = 'Seurat_markers.top50', '/path/to/Visium_data/Kidney_data/scRNAseq_kidney/1-s2.0-S1534580719308147-mmc2.xlsx')) # data not provided
