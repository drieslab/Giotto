...
![](./mouse_kidney_highres.png){width=16cm} 

Spots labeled according to whether they were covered by tissue or not:  
![](./figures/1_in_tissue.png){width=16cm} 
...
![](./figures/1_nr_genes.png){width=16cm} 
...
![](./figures/6_PAGE_spatplot_0_8.png){width=16cm} 

![](./figures/6_PAGE_spatplot_9_17.png){width=16cm} 


![](./figures/6_PAGE_spatplot_18_26.png){width=16cm} 


![](./figures/6_PAGE_spatplot_27_30.png){width=16cm} 
...
b = 5  
![](./figures/10_HMRF_k5_b.20.png){width=16cm} 
