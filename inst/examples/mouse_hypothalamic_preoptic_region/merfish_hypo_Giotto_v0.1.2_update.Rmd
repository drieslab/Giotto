...
expr = read.table(paste0(data_dir, '/', 'count_matrix/merFISH_3D_data_expression.txt')) # file in zip format: merFISH_3D_data_expression.txt.zip
...
type_level = read.table(paste0(data_dir, '/', 'cell_types/merFISH_3D_data_type_levels.txt')) # file missing
```
