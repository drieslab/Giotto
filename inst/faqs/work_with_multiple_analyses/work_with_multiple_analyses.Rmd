...
We will use the seqFish+ somatosensory cortex as an example dataset after creating and processing a [Giotto object](./inst/faqs/work_with_multiple_analyses/work_with_multiple_analyses.md).
