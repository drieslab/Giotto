...
```{r eval=FALSE}
# giotto object 
download.file("https://raw.githubusercontent.com/RubD/Giotto/master/inst/extdata/seqfish_field_expr.txt.gz", destfile = "seqfish_field_expr.txt.gz")
expr_path = "seqfish_field_expr.txt.gz"

download.file("https://raw.githubusercontent.com/RubD/Giotto/master/inst/extdata/seqfish_field_locs.txt", destfile = "seqfish_field_locs.txt")
loc_path = "seqfish_field_locs.txt"
...
spatDimPlot(gobject = seqfish_mini, 
            cell_color = 'leiden_clus', spat_point_shape = 'voronoi')
...
violinPlot(seqfish_mini, 
           feats = topgenes_gini$feats, cluster_column = 'leiden_clus')
...
## visualize all genes
plotCellProximityGenes(seqfish_mini, 
...
```{r eval=FALSE}
download.file("https://raw.githubusercontent.com/RubD/Giotto/master/inst/extdata/mouse_ligand_receptors.txt", destfile = "mouse_ligand_receptors.txt")
LR_data = data.table::fread("mouse_ligand_receptors.txt")
