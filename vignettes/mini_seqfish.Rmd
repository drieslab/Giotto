...
violinPlot(seqfish_mini, genes = topgenes_gini$feats[1:4], cluster_column = 'leiden_clus')

# get top 6 genes per cluster and visualize with heatmap
topgenes_gini2 = gini_markers[, head(.SD, 6), by = 'cluster']
plotMetaDataHeatmap(seqfish_mini, selected_genes = topgenes_gini2$feats,
...
plotHeatmap(gobject = seqfish_mini,
            genes = topgenes_heatmap$feats, 
            gene_order = 'custom',
            gene_custom_order = unique(topgenes_heatmap$feats),
...
seqfish_mini = createMetagenes(seqfish_mini,
