...
# Giotto 0.3.2  
- added voronoi plots to use in spatial plotting. See [howto's](./docs/articles/howto_voronoi_plots.html)
...
- updated [howto's](./docs/articles/getting_started.html) tutorials in Start section
