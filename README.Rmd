...
[![R-CMD-check](https://github.com/yeung-jsn/Giotto/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/yeung-jsn/Giotto/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
...
These technologies differ in terms of resolution (subcellular, single cell or multiple cells), spatial dimension (2D vs 3D), molecular modality (protein, RNA, DNA, ...), and throughput (number of cells and analytes). More information and documentation about Giotto Suite can be found at http://giottosuite.com/index.html.
